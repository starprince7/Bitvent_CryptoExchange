...
class BinanceChart extends Component {
    
    fetchBinanceCoinData = () => {
        axios.get('https://min-api.cryptocompare.com/data/histoday?fsym=BNB&tsym=USD&limit=30')
        .then(res => {
            ...
            // console.log('Parsed BNB Data', data)
